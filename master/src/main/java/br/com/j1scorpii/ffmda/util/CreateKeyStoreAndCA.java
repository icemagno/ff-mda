    ...
    */
	public static void main(String[] args)  {
		try {
            ...
            X500Name acDefesaIssuer = new X500Name("CN=TESTE Autoridade Certificadora Minist�rio da Defesa, O=AC-Defesa, OU=Minist�rio da Defesa, OU=CERTIFICADO DE TESTE, ST=TESTE CASNAV, C=BR");
            ...
            X500Name arDefesaIssuer = new X500Name("CN=TESTE Autoridade Registradora Minist�rio da Defesa, O=AR-Defesa, OU=Minist�rio da Defesa, OU=CERTIFICADO DE TESTE, ST=TESTE CASNAV, C=BR");
			...
			*/
			...
			createUserCertCasnav(arDefesaAlias, "07946532865", "Sebasti�o Alves da Silva", arDefesaIssuer);
			createUserCertCasnav(arDefesaAlias, "12386616703", "Arthur Azevedo de Andrade", arDefesaIssuer);
			createUserCertCasnav(arDefesaAlias, "08097752719", "Jonathas Pac�fico de Souza", arDefesaIssuer);
			...
			createUserCertSegma(arDefesaAlias, "06594965859", "M�RIO CELSO TEIXEIRA LOPES", arDefesaIssuer);
			...
			createUserCertSegma(arDefesaAlias, "71510753168", "GERL�NIA SZERVINSK PEREIRA", arDefesaIssuer);
	...
	private static void createUserCertDefesa( String emissorAlias, String cpf, String name, X500Name emissor) {
        ...
        X500Name requerente = new X500Name("CN="+cn+", O=Defesa, OU=Minist�rio da Defesa, ST=TESTE CASNAV, C=BR");
	...
	private static void createUserCertSegma( String emissorAlias, String cpf, String name, X500Name emissor) {
    	String certificateFile = "d:/certs/" + cpf;
    	String cn = name.toUpperCase() + ":" + cpf;
        X500Name requerente = new X500Name("CN="+cn+", O=SEGMA, OU=Minist�rio da Defesa, ST=TESTE CASNAV, C=BR");
		ss.createUserCertAndSignWithAC( emissorAlias, cpf, keyStoreFileEmissor, certificateFile, keyStorePassword, privateKeyPassword, requerente, emissor );
	}
